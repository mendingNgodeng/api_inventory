...
export class rentalCustomerController {
  ...
  static async getAll(c: Context) {
    try {
      const data = await rentalCustomerService.getAll();
  ...
  static async get(c: Context) {
    ...
    if (isNaN(numericId)) {
      ...
      const data = await rentalCustomerService.getById(numericId);
  ...
  static async create(c: Context) {
    try {
      ...
      const data = await rentalCustomerService.create(result.data);
  ...
  static async update(c: Context) {
      try {
        ...
        const data = await rentalCustomerService.update(numericId, result.data);
  ...
  static async delete(c: Context) {
    ...
    if (isNaN(numericId)) {
      ...
      await rentalCustomerService.delete(numericId);
