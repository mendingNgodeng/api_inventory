...
import { CreateAssetSchema,UpdateAssetSchema } from '../validation/asset.validation';
...
export class assetController {
  ...
  static async get(c: Context) {
    ...
    if (isNaN(numericId)) {
      ...
      const data = await assetService.getById(numericId);
  ...
  static async create(c: Context) {
    try {
      ...
      const data = await assetService.create(result.data);
  ...
  static async update(c: Context) {
      try {
        ...
        const data = await assetService.update(numericId, result.data);
  ...
  static async delete(c: Context) {
    ...
    if (isNaN(numericId)) {
      ...
      await assetService.delete(numericId);
