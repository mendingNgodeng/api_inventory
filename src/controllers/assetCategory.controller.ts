...
import { Schema } from '../validation/assetCategory.validation';
...
export class AssetCategoryController {
  ...
  static async get(c: Context) {
    ...
    if (isNaN(numericId)) {
      ...
      const data = await AssetCategoryService.getById(numericId);
  ...
  static async create(c: Context) {
    try {
      ...
      const data = await AssetCategoryService.create(result.data);
  ...
  static async update(c: Context) {
    try {
      ...
      const data = await AssetCategoryService.update(numericId, result.data);
  ...
  static async delete(c: Context) {
    ...
    if (isNaN(numericId)) {
      ...
      await AssetCategoryService.delete(numericId);
